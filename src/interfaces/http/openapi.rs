...
#[openapi(
  ...
  paths(
    crate::interfaces::http::health::handler,
    crate::interfaces::http::api_v1::rules::get::list_rules,
    crate::interfaces::http::api_v1::rules::post::create_rule,
    crate::interfaces::http::api_v1::rules::get::get_rule,
    crate::interfaces::http::api_v1::rules::put::update_rule,
    crate::interfaces::http::api_v1::rules::patch::patch_rule,
    crate::interfaces::http::api_v1::rules::delete::delete_rule,
    crate::interfaces::http::api_v1::engine::status,
    crate::interfaces::http::api_v1::engine::reload,
    crate::interfaces::http::api_v1::decisions::create_decision,
    crate::interfaces::http::api_v1::decisions::create_decision_trace,
    crate::interfaces::http::api_v1::ui::builder_config
  ),
  components(
    schemas(
      HealthResponse,
