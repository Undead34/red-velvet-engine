...
#[openapi(
  ...
  paths(
    ...
    crate::http::api_v1::rules::get::list_rules,
    crate::http::api_v1::rules::post::create_rule,
    crate::http::api_v1::rules::get::get_rule,
    crate::http::api_v1::rules::put::update_rule,
    crate::http::api_v1::rules::patch::patch_rule,
    crate::http::api_v1::rules::delete::delete_rule,
